import{_ as l,r as p,o as i,c as o,b as n,d as s,e as t,a}from"./app-U2nchfLp.js";const c="/assets/image-20200407121501907-l1bLVnrl.png",u="/assets/image-20200412111402706-1626782188724-HZbhoOYJ.png",d="/assets/image-20200406184656917-nSFC-Wr-.png",r="/assets/image-20200605021831545-yP7PsYDc.png",v="/assets/image-20200514095913741-Yg04l_zJ.png",k={},m={href:"https://gitee.com/yooome/golang/blob/main/k8s%E8%AF%A6%E7%BB%86%E6%95%99%E7%A8%8B/Kubernetes%E8%AF%A6%E7%BB%86%E6%95%99%E7%A8%8B.md#5-pod%E8%AF%A6%E8%A7%A3",target:"_blank",rel:"noopener noreferrer"},b={href:"https://www.bilibili.com/video/BV1Qv41167ck?p=24",target:"_blank",rel:"noopener noreferrer"},g=a('<h1 id="_5-pod详解" tabindex="-1"><a class="header-anchor" href="#_5-pod详解" aria-hidden="true">#</a> 5 Pod详解</h1><h2 id="_5-1-pod介绍" tabindex="-1"><a class="header-anchor" href="#_5-1-pod介绍" aria-hidden="true">#</a> 5.1 Pod介绍</h2><h3 id="_5-1-1-pod结构" tabindex="-1"><a class="header-anchor" href="#_5-1-1-pod结构" aria-hidden="true">#</a> 5.1.1 Pod结构</h3><p><img src="'+c+`" alt="image-20200407121501907"></p><p>每个Pod中都可以包含一个或者多个容器，这些容器可以分为两类：</p><ul><li>用户程序所在的容器，数量可多可少</li><li>Pause容器，这是每个Pod都会有的一个<strong>根容器</strong>，它的作用有两个： <ul><li>可以以它为依据，评估整个Pod的健康状态</li><li>可以在根容器上设置Ip地址，其它容器都此Ip（Pod IP），以实现Pod内部的网路通信 这里是Pod内部的通讯，Pod的之间的通讯采用虚拟二层网络技术来实现，我们当前环境用的是Flannel</li></ul></li></ul><h3 id="_5-1-2-pod定义" tabindex="-1"><a class="header-anchor" href="#_5-1-2-pod定义" aria-hidden="true">#</a> 5.1.2 Pod定义</h3><p>下面是Pod的资源清单：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1     <span class="token comment">#必选，版本号，例如v1</span>
