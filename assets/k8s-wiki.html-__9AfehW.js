import{_ as t,r as p,o as i,c as l,b as n,d as s,e,a as c}from"./app-CTlNizBn.js";const o="/assets/wiki-language-W8C_NslO.png",u="/assets/wiki-search-nzuSO0Xr.png",r="/assets/wiki-storage-1OuB8EEy.png",d="/assets/wiki-search-1-OlKNWTsW.png",k={},v={href:"https://blog.csdn.net/fenglailea/article/details/128615789",target:"_blank",rel:"noopener noreferrer"},m={href:"https://js.wiki/",target:"_blank",rel:"noopener noreferrer"},b=n("h1",{id:"k8s部署-wiki-js-带中文分词",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#k8s部署-wiki-js-带中文分词","aria-hidden":"true"},"#"),s(" k8s部署 wiki.js ,带中文分词")],-1),y=n("h2",{id:"_1-1-k8s-postgres-安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-1-k8s-postgres-安装","aria-hidden":"true"},"#"),s(" 1.1 k8s postgres 安装")],-1),h=n("p",null,"因为包含中文分词，要在原版的基础上增加分词插件,这里直接使用别人已经制作好的镜像",-1),g={href:"https://github.com/abcfy2/docker_zhparser",target:"_blank",rel:"noopener noreferrer"},w={href:"https://hub.docker.com/r/abcfy2/zhparser",target:"_blank",rel:"noopener noreferrer"},_=c(`<p>这里选择 <code>postgres 15</code> 版本，即 <code>docker pull abcfy2/zhparser:15-alpine</code></p><p>那么最后的 <code>k8s postgres</code> 配置文件如下</p><h3 id="postgresql-pod-yml" tabindex="-1"><a class="header-anchor" href="#postgresql-pod-yml" aria-hidden="true">#</a> postgresql-pod.yml</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="postgresql-svc-yml" tabindex="-1"><a class="header-anchor" href="#postgresql-svc-yml" aria-hidden="true">#</a> postgresql-svc.yml</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>目录设置</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /www/websites/postgresql/data
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置-wiki-数据库" tabindex="-1"><a class="header-anchor" href="#配置-wiki-数据库" aria-hidden="true">#</a> 配置 wiki 数据库</h2><h3 id="进入pod" tabindex="-1"><a class="header-anchor" href="#进入pod" aria-hidden="true">#</a> 进入pod</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>kubectl <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> <span class="token variable"><span class="token variable">\`</span>kubectl get pods <span class="token operator">|</span> <span class="token function">grep</span> postgres <span class="token operator">|</span>  <span class="token function">awk</span> <span class="token string">&#39;{print $1}&#39;</span><span class="token variable">\`</span></span> <span class="token function">bash</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="创建-wikijs-用户" tabindex="-1"><a class="header-anchor" href="#创建-wikijs-用户" aria-hidden="true">#</a> 创建 wikijs 用户</h3><p>登录</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 登陆 fox用户</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后 <code>exit</code> 退出数据库命令行</p><h3 id="设置-wikijs-用户下配置" tabindex="-1"><a class="header-anchor" href="#设置-wikijs-用户下配置" aria-hidden="true">#</a> 设置 wikijs 用户下配置</h3><p>登录</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 登陆 wikijs用户</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后 <code>exit</code> 退出数据库命令行</p><p>登录 fox 用户</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 登陆 fox用户</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后 <code>exit</code> 退出数据库命令行</p><p>到此数据库配置完成</p><h2 id="k8s-配置-wiki" tabindex="-1"><a class="header-anchor" href="#k8s-配置-wiki" aria-hidden="true">#</a> k8s 配置 wiki</h2><h3 id="wiki-pod-yml" tabindex="-1"><a class="header-anchor" href="#wiki-pod-yml" aria-hidden="true">#</a> wiki-pod.yml</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
<span class="token key atrule">kind</span><span class="token punctuation">:</span> Deployment
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
  <span class="token key atrule">labels</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
        ...
        <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> vm<span class="token punctuation">-</span>content
          <span class="token key atrule">hostPath</span><span class="token punctuation">:</span>
            ...
            <span class="token comment"># hostPath 卷指定 type，如果目录不存在则创建(可创建多层目录)</span>
            <span class="token key atrule">type</span><span class="token punctuation">:</span> DirectoryOrCreate
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="wiki-svc-yml" tabindex="-1"><a class="header-anchor" href="#wiki-svc-yml" aria-hidden="true">#</a> wiki-svc.yml</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
<span class="token key atrule">kind</span><span class="token punctuation">:</span> Service
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
  <span class="token key atrule">name</span><span class="token punctuation">:</span> wiki
  <span class="token key atrule">labels</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>目录设置</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /www/websites/wiki/data
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>把上面显示的内容复制到主机 <code>/www/websites/wiki/search/definition.yml</code> 文件中，如果没有目录的，要先创建好目录或文件 修改 <code>/www/websites/wiki/search/definition.yml</code> 文件 ，案例如下 主要是在 <code>- turkish</code> 下面一行增加 <code>- chinese_zh</code> 格式要一致</p><p>请不要直接复制以下案例内容，因为有的版本该文件会增加其他功能字段</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">key</span><span class="token punctuation">:</span> postgres
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置-wiki" tabindex="-1"><a class="header-anchor" href="#配置-wiki" aria-hidden="true">#</a> 配置 wiki</h2><p>通过域名打开 <code>http://ip:30300</code> ,开始配置wiki。配置管理员邮箱、密码、wiki登录地址。</p><h3 id="配置中文" tabindex="-1"><a class="header-anchor" href="#配置中文" aria-hidden="true">#</a> 配置中文</h3><p>如果要配置语言为中文的的，在这个页面下 <code>http://ip:30300/a/locale</code></p><p><img src="`+o+'" alt="切换语言"></p><h3 id="配置中文搜索" tabindex="-1"><a class="header-anchor" href="#配置中文搜索" aria-hidden="true">#</a> 配置中文搜索</h3><p>wiki.js -&gt; 管理 -&gt; 搜索引擎 -&gt; Database - PostgreSQL -&gt; Dictionary Language</p><p>选 chinese_zh</p><p><img src="'+u+'" alt="搜索引擎"></p><h3 id="配置文件存储" tabindex="-1"><a class="header-anchor" href="#配置文件存储" aria-hidden="true">#</a> 配置文件存储</h3><p>如果不配置，那么文件创建，或者上传文件会在pod容器内部，无法持久话，会丢失附件 配置板 -&gt; 存储 -&gt; Local File System -&gt; 目标配置 内容修改为 <code>/wiki/content</code> 最后应用并生效</p><p><img src="'+r+'" alt="配置存储"></p><p>此时就可以使用全文检索了，如果检索不到，可以进行手动更新索引</p><p><img src="'+d+'" alt="搜索引擎"></p>',69);function f(P,E){const a=p("ExternalLinkIcon");return i(),l("div",null,[n("p",null,[n("a",v,[s("原文链接"),e(a)]),s(),n("a",m,[s("wiki官网"),e(a)])]),b,y,h,n("p",null,[s("github 地址 : "),n("a",g,[s("https://github.com/abcfy2/docker_zhparser"),e(a)])]),n("p",null,[s("镜像地址： "),n("a",w,[s("https://hub.docker.com/r/abcfy2/zhparser"),e(a)])]),_])}const S=t(k,[["render",f],["__file","k8s-wiki.html.vue"]]);export{S as default};
