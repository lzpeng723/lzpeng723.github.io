import{_ as s,r,o,c as l,b as n,d as e,e as t,a as d}from"./app-pZatn4kd.js";const u={},a=d(`<h2 id="docker-安装" tabindex="-1"><a class="header-anchor" href="#docker-安装" aria-hidden="true">#</a> Docker 安装</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 安装 yum-utils
...
E: Unable to correct problems, you have held broken packages.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>意思是libapt-pkg5.0版本没法安装，经过检查后发现是提前修改了apt源,将apt源设为默认即可</p><h2 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h2>`,18),m={href:"https://www.runoob.com/docker",target:"_blank",rel:"noopener noreferrer"};function b(h,p){const i=r("ExternalLinkIcon");return o(),l("div",null,[a,n("p",null,[e("阿里云的加速器：https://<你的ID>.mirror.aliyuncs.com "),n("a",c,[e("申请地址"),t(i)])]),v,n("p",null,[e("好了，Docker 安装完毕，开始愉快的学习 Docker 吧，"),n("a",m,[e("Docker学习教程"),t(i)]),e("。")])])}const k=s(u,[["render",b],["__file","linux-install-Docker.html.vue"]]);export{k as default};
