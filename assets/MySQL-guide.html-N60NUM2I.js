import{_ as s,o as a,c as n,a as e}from"./app-sSOuSl-P.js";const l={},i=e(`<h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h2><h3 id="too-many-connections" tabindex="-1"><a class="header-anchor" href="#too-many-connections" aria-hidden="true">#</a> too many connections</h3><p>查看最大连接数 show variables like &#39;%max_connections%&#39;; 显示所有连接 show processlist; 删除连接 kill 1180421; 修改最大连接数(临时生效,无需重启服务) set GLOBAL max_connections=1024; 修改最大连接数(需重启服务,永久生效) 修改my.cnf， vim /etc/my.cnf, 加入max_connections=1024</p><h3 id="重置密码" tabindex="-1"><a class="header-anchor" href="#重置密码" aria-hidden="true">#</a> 重置密码</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mysqladmin -u root password NEWPASS
