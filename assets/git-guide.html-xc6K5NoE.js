import{_ as i,r as t,o as c,c as l,b as s,d as n,e as p,a}from"./app-U2nchfLp.js";const o={},u=a(`<h1 id="常用-git-命令清单" tabindex="-1"><a class="header-anchor" href="#常用-git-命令清单" aria-hidden="true">#</a> 常用 Git 命令清单</h1><p>我每天使用 Git ，但是很多命令记不住。</p><p>一般来说，日常使用只要记住下图6个命令，就可以了。但是熟练使用，恐怕要记住60～100个命令。 <img src="https://www.ruanyifeng.com/blogimg/asset/2015/bg2015120901.png" alt="git"></p><p>下面是我整理的常用 Git 命令清单。几个专用名词的译名如下。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Workspace：工作区
Index / Stage：暂存区
Repository：仓库区（或本地仓库）
Remote：远程仓库
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),d={href:"https://oschina.gitee.io/learn-git-branching",target:"_blank",rel:"noopener noreferrer"},m=a(`<h2 id="一、新建代码库" tabindex="-1"><a class="header-anchor" href="#一、新建代码库" aria-hidden="true">#</a> 一、新建代码库</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 在当前目录新建一个Git代码库</span>
...
$ <span class="token function">git</span> clone <span class="token punctuation">[</span>-b branch<span class="token punctuation">]</span> <span class="token punctuation">[</span>url<span class="token punctuation">]</span>
...
<span class="token comment"># 常用提交前缀</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;初始化项目&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;refactor: 即不是新增功能，也不是修改bug的代码变动&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;feat: 新功能&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;feature: 新功能&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;fix: 修补bug&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;docs: 文档&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;documentation: 文档&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;style: 不影响代码运行的变动&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;test: 增加测试&quot;</span>
$ <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&quot;chore: 构建过程或辅助工具的变动&quot;</span>
...
$ <span class="token function">git</span> push origin :<span class="token punctuation">[</span>branch-name<span class="token punctuation">]</span>

<span class="token comment"># 创建远程分支(本地分支push到远程)</span>
$ <span class="token function">git</span> push origin <span class="token punctuation">[</span>name<span class="token punctuation">]</span>

<span class="token comment"># 提交本地test分支作为远程的master分支</span>
$ <span class="token function">git</span> push origin test:master
...
<span class="token comment"># 修改源地址</span>
$ <span class="token function">git</span> remote set-url <span class="token punctuation">[</span>shortname<span class="token punctuation">]</span> <span class="token punctuation">[</span>url<span class="token punctuation">]</span>

<span class="token comment"># 删除源地址</span>
$ <span class="token function">git</span> remote remove <span class="token punctuation">[</span>shortname<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="十一、-github-fork后与源项目保持同步" tabindex="-1"><a class="header-anchor" href="#十一、-github-fork后与源项目保持同步" aria-hidden="true">#</a> 十一、 Github fork后与源项目保持同步</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 增加被fork的仓库地址</span>
$ <span class="token function">git</span> remote <span class="token function">add</span> upstream <span class="token operator">&lt;</span>源项目url.git<span class="token operator">&gt;</span>

<span class="token comment"># 抓取原仓库的修改文件</span>
$ <span class="token function">git</span> fetch upsrteam <span class="token operator">&lt;</span>branch<span class="token operator">&gt;</span>

<span class="token comment"># 回到master分支，或者确定所在的分支是master</span>
$ <span class="token function">git</span> checkout master

<span class="token comment"># 将更新的源项目分支合并到自己的项目上</span>
$ <span class="token function">git</span> merge upstream/master

<span class="token comment"># 将本地仓库push到Github上</span>
$ <span class="token function">git</span> push origin master
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23);function r(v,k){const e=t("ExternalLinkIcon");return c(),l("div",null,[u,s("p",null,[n("有兴趣的同学可以去 "),s("a",d,[n("此网站"),p(e)]),n(" 进行练习 Git 命令")]),m])}const g=i(o,[["render",r],["__file","git-guide.html.vue"]]);export{g as default};
