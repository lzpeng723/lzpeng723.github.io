import{_ as n,o as s,c as a,a as e}from"./app-rBywrD27.js";const t={},p=e(`<h1 id="ansible-给多台主机安装-docker" tabindex="-1"><a class="header-anchor" href="#ansible-给多台主机安装-docker" aria-hidden="true">#</a> ansible 给多台主机安装 docker</h1><h2 id="编写-ansible-cfg-文件" tabindex="-1"><a class="header-anchor" href="#编写-ansible-cfg-文件" aria-hidden="true">#</a> 编写 ansible.cfg 文件</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
