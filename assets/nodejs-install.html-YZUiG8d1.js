import{_ as a,r as d,o as l,c as r,b as n,d as e,e as i,a as s}from"./app-pZatn4kd.js";const c={},o=n("h2",{id:"_1-下载node",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-下载node","aria-hidden":"true"},"#"),e(" 1 下载node")],-1),m={href:"https://nodejs.org/",target:"_blank",rel:"noopener noreferrer"},v=n("code",null,"Path",-1),p=s(`<p>验证是否安装成功</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>node -v
npm -v
