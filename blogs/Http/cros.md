...
[浏览器的同源策略](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS#Preflighted_requests)
[参考文章](https://zhuanlan.zhihu.com/p/165945581)
[跨域请求发送流程](https://blog.csdn.net/u012501054/article/details/84519574)
...
## Access-Control-Allow-Origin:*是否存在漏洞

[Access-control-allow-origin:*并没有实际危害](https://blog.csdn.net/haoren_xhf/article/details/80050311)
简单来说如果是*，则不允许携带cookie
